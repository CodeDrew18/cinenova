  ...
  return (
    <div className="pt-24 pb-20 bg-neutral-950 min-h-screen">
      <div className="px-4 md:px-12 mb-10 border-l-8 border-red-600 ml-4 md:ml-12">
        ...
        <p className="text-neutral-500 mt-2 font-bold tracking-widest uppercase text-xs">Japanese Animation Excellence</p>
      </div>
      
      <MediaRow title="Featured Collection" items={anime.results} />
      <MediaRow title="Action & Shonen" items={anime.results.slice().reverse()} />
    </div>
  );
}